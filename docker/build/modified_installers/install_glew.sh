...
# Install OpenGL
# echo "deb http://ppa.launchpad.net/keithw/glfw3/ubuntu Bionic main" | \
#     tee -a /etc/apt/sources.list.d/fillwave_ext.list
# echo "deb-src http://ppa.launchpad.net/keithw/glfw3/ubuntu Bionic main" | \
#     tee -a /etc/apt/sources.list.d/fillwave_ext.list
apt-get update -y
